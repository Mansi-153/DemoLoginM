...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_NAME = "Employee_Record";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE "+TABLE_NAME+" (ID INTEGER PRIMARY KEY AUTOINCREMENT,Name TEXT,Department TEXT,Salary INTEGER)");
        }
    ...
    public boolean insertData(String id, String name,String department,String salary){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues content = new ContentValues();
        content.put(COL_1, id);
        content.put(COL_2, name);
        content.put(COL_3, department);
        content.put(COL_4, salary);
    ...
    public boolean updateAll(String id, String name ,String surname, String marks){
